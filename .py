...
time = 0
started = False
ROCK_RADIUS = 20 # nevermind  don't build your code this way
other_object = True 
rock_shift = 1
...
class Ship:
    ...
    def update(self):
        ...
        #if self.pos[0] <= ROCK_RADIUS or self.pos[0] >= WIDTH - ROCK_RADIUS:
...
def draw(canvas):
    ...
    canvas.draw_text("Lives", [50, 50], 22.5, "Red")
    canvas.draw_text("Score", [680, 50], 22, "White")
    canvas.draw_text(str(lives), [50, 80], 22.5, "Red")
